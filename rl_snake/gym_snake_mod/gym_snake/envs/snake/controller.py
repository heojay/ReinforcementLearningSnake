...
class Controller():
    ...
    def __init__(self, grid_size=[30,30], unit_size=10, unit_gap=1, snake_size=3, n_snakes=1, n_foods=1, random_init=True, start_coord=None, food_pos=None):
        ...
        if food_pos is not None:
            assert food_pos[0] < grid_size[0] # added 20190519 in mod19 version
            assert food_pos[1] < grid_size[1] # added 20190519 in mod19 version
